    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          <p className="text-sm text-gray-500 mb-6">Sign in to track your progress</p>
          ...
          <div className="space-y-3 mb-6">
            ...
            <button
              ...
              disabled={!!loading}
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-black text-white rounded-lg hover:bg-gray-900 transition-colors text-sm font-medium disabled:opacity-50"
            >
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={!!loading}
              className="w-full py-2.5 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 font-medium text-sm transition-colors disabled:opacity-50"
            >
          ...
          <p className="mt-4 text-center text-xs text-gray-400">
            Don't have an account? Just enter your email and password — we'll create one automatically.
          </p>
        </div>
      </div>
    </div>
