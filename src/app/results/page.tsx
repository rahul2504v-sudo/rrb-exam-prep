...
import { BarChart3, Clock, Target, Trophy, Trash2, ChevronRight, FileText } from 'lucide-react';
...
export default function ResultsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">{t('yourResults')}</h1>

      {sessions.length === 0 ? (
        <div className="card text-center py-16">
          <BarChart3 className="w-16 h-16 text-gray-300 mx-auto mb-4" />
          <h2 className="text-xl font-semibold text-gray-700 mb-2">{t('noResults')}</h2>
        ...
        <>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
            <div className="card text-center">
              ...
              <div className="text-xs text-gray-500">{t('testsTaken')}</div>
            </div>
            <div className="card text-center">
            ...
            <div className="card text-center">
              ...
              <div className="text-xs text-gray-500">{t('averageScore')}</div>
            </div>
            <div className="card text-center">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        {exam?.name || 'Unknown'} • {session.correctAnswers}/{session.totalQuestions} {t('correct').toLowerCase()}
                      </p>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right hidden sm:block">
                      <div className="text-sm font-medium text-gray-700">
                        {t('score')}: {session.score.toFixed(1)}
                      </div>
                      <div className="text-xs text-gray-400">{formatTime(session.timeTaken)}</div>
                    </div>
