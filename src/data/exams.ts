  ...
  },
  {
    ...
    pattern: {
      sections: [
        ...
        { name: 'General Science', questionCount: 20, marks: 20 },
    ...
    subjects: [
      { id: 'alp-mathematics', name: 'Mathematics', slug: 'mathematics', topics: ntpMathematics.topics.map(t => ({ ...t, id: t.id.replace('ntpc-', 'alp-') })) },
      { id: 'alp-reasoning', name: 'General Intelligence & Reasoning', slug: 'reasoning', topics: ntpReasoning.topics.map(t => ({ ...t, id: t.id.replace('ntpc-', 'alp-') })) },
      { id: 'alp-science', name: 'General Science', slug: 'general-science', topics: gdScience.topics.slice(0, 10).map(t => ({ ...t, id: t.id.replace('group-d-', 'alp-') })) },
      { id: 'alp-awareness', name: 'General Awareness', slug: 'general-awareness', topics: ntpGeneralAwareness.topics.slice(0, 8).map(t => ({ ...t, id: t.id.replace('ntpc-gk-', 'alp-gk-') })) },
    ],
    status: 'ongoing',
  },
  {
    id: 'technician',
    name: 'RRB Technician 2026',
    slug: 'technician',
    description: 'Grade I Signal & Grade III — Notification June 29, 2026',
    icon: 'Wrench',
    color: 'rail-green',
    totalVacancies: 6557,
    pattern: {
      sections: [
        ...
        { name: 'General Intelligence & Reasoning', questionCount: 25, marks: 25 },
        { name: 'General Science', questionCount: 25, marks: 25 },
        { name: 'General Awareness', questionCount: 25, marks: 25 },
      ],
      totalQuestions: 100,
      totalMarks: 100,
      durationMinutes: 90,
    ...
    subjects: [
      { id: 'tech-mathematics', name: 'Mathematics', slug: 'mathematics', topics: ntpMathematics.topics.slice(0, 12).map(t => ({ ...t, id: t.id.replace('ntpc-', 'tech-') })) },
      { id: 'tech-reasoning', name: 'General Intelligence & Reasoning', slug: 'reasoning', topics: ntpReasoning.topics.slice(0, 10).map(t => ({ ...t, id: t.id.replace('ntpc-', 'tech-') })) },
      { id: 'tech-science', name: 'General Science', slug: 'general-science', topics: gdScience.topics.slice(0, 15).map(t => ({ ...t, id: t.id.replace('group-d-', 'tech-') })) },
      { id: 'tech-awareness', name: 'General Awareness', slug: 'general-awareness', topics: ntpGeneralAwareness.topics.slice(0, 10).map(t => ({ ...t, id: t.id.replace('ntpc-gk-', 'tech-gk-') })) },
    ],
    status: 'notified',
  },
  {
